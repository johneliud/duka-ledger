...
export function SalesHistory() {
	...
	return (
		<div className="max-w-2xl mx-auto p-4">
			<h1 className="text-2xl font-bold text-text mb-4">Sales History</h1>
			...
			<div className="bg-surface border border-border rounded p-4 mb-4">
				<div className="text-sm text-muted">Total for period</div>
				<div className="text-2xl font-bold text-primary">KSh {total.toLocaleString()}</div>
			</div>
