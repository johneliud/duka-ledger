...
export function Landing({
  ...
  const carouselItems = [
    {
      icon: TrendingUp,
      title: t("landing.carousel.trackSales"),
      description: t("landing.carousel.trackSalesDesc"),
    },
    {
      icon: Package,
      title: t("landing.carousel.manageInventory"),
      description: t("landing.carousel.manageInventoryDesc"),
    },
    {
      icon: Receipt,
      title: t("landing.carousel.trackExpenses"),
      description: t("landing.carousel.trackExpensesDesc"),
    },
    {
      icon: Users,
      title: t("landing.carousel.debtBook"),
      description: t("landing.carousel.debtBookDesc"),
    },
  ];
              ...
              <div>
                <h1 className="text-5xl lg:text-6xl font-bold text-text mb-6 tracking-tight">
                  ...
                  <span className="text-primary">
                    {t("landing.hero.ledger")}
                  </span>
                  {t("landing.hero.digitized")}
                </h1>
